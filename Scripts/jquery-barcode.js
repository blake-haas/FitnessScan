...
(function ($) {
  ...
  var barcode = {
    ...
    digitToSvgRenderer: function($container, settings, digit, hri, mw, mh){
      ...
      // svg header
      var svg = '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" baseProfile="basic" preserveAspectRatio="xMinYMin meet" class="svg-content" viewBox="0 0 ' +width+ ' ' +height+ '">';
      
      // background
      svg += '<rect width="100%" height="100%" x="0" y="0" fill="' + settings.bgColor + '" />';
